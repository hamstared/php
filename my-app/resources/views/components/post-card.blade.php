<x-layout>
    <li class="border border-gray-300 rounded-lg p-6 shadow-sm bg-gray-50" x-data="{ showComments: false }">
        ...
        <button @click="showComments = !showComments" x-if="showComments == false" class="mb-4 px-4 py-2 w-auto bg-blue-600 text-white font-bold rounded hover:bg-blue-700 transition">
            Hide Comments
        </button>
        <button @click="showComments = !showComments" x-if="showComments == true" class="mb-4 px-4 py-2 w-auto bg-blue-600 text-white font-bold rounded hover:bg-blue-700 transition">
            Show Comments
        </button>
        <div class="bg-gray-100 p-4 rounded mb-4" x-show="showComments" x-transition>
