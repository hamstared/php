    ...
    <div class="container">
        ...
        <form method="POST" action="/register" class="bg-white p-8 rounded-lg shadow-md">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" required class="w-full px-3 py-2 rounded text-black border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-300">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" required class="w-full px-3 py-2 rounded text-black border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-300">
            </div>
        ...
        <p class="mt-4 text-center">Already have an account? <a href="/login" class="underline text-blue-600 hover:text-blue-800">Login here</a></p>
    </div>
</body>
